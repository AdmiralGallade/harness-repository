...
> **Attribution:** This harness is sourced from [wshobson/agents-marketplace](https://github.com/wshobson/agents) by [@wshobson](https://github.com/wshobson), used under the MIT License. No modifications have been made to the original files.

> Production-ready agentic workflow building blocks: **84 plugins**, **192 agents**,
> **156 skills**, **102 commands** â€” built for Claude Code and consumed natively by
...
> harness-native artifacts â€” not lowest-common-denominator translations.
...
[â†’ Full Claude Code setup, troubleshooting, and plugin catalog](docs/usage.md)

### Codex CLI Â· Cursor Â· OpenCode Â· Gemini CLI Â· Copilot
...
Browse the catalog: [docs/plugins.md](docs/plugins.md) Â· [docs/agents.md](docs/agents.md) Â· [docs/agent-skills.md](docs/agent-skills.md)
...
context** â€” not the whole marketplace.

```
plugins/python-development/
â”œâ”€â”€ .claude-plugin/plugin.json
â”œâ”€â”€ agents/             # 3 Python agents (python-pro, django-pro, fastapi-pro)
â”œâ”€â”€ commands/           # 1 scaffolding command
â””â”€â”€ skills/             # 16 specialized skills (async, testing, packaging, â€¦)
```
...
| 2 | inherit  | User-chosen â€” backend, frontend, AI/ML, specialized |
| 3 | Sonnet   | Docs, testing, debugging, API references |
| 4 | Haiku    | Fast operational tasks, SEO, deployment, content |

[â†’ Model configuration details](docs/agents.md#model-configuration)
...
| **Codex CLI** | `.agents/plugins/marketplace.json` + `plugins/*/.codex-plugin/plugin.json` (committed); `.codex/skills/`, `.codex/agents/` (gitignored) | 8 KB skill cap respected; commands â†’ skills |
...
[â†’ Full capability matrix and per-harness deep-dives](docs/harnesses.md)
...
- **Static** â€” deterministic structural analysis (<2s, free)
- **LLM Judge** â€” semantic evaluation across 4 dimensions (~30s, Haiku + Sonnet)
- **Monte Carlo** â€” statistical reliability via 50-100 simulated runs (~2-5 min)
...
[â†’ PluginEval framework documentation](docs/plugin-eval.md)

## Documentation map

Detail lives in `docs/`. Read in this order:

- **[docs/plugins.md](docs/plugins.md)** â€” full catalog of all 84 plugins
- **[docs/agents.md](docs/agents.md)** â€” all 192 agents by category
- **[docs/agent-skills.md](docs/agent-skills.md)** â€” 156 skills with progressive disclosure
- **[docs/usage.md](docs/usage.md)** â€” commands, workflows, examples
- **[docs/architecture.md](docs/architecture.md)** â€” design principles
- **[docs/harnesses.md](docs/harnesses.md)** â€” cross-harness capability matrix
- **[docs/authoring.md](docs/authoring.md)** â€” portable-content style guide
- **[docs/plugin-eval.md](docs/plugin-eval.md)** â€” quality evaluation framework
- **[docs/round-trip-results.md](docs/round-trip-results.md)** â€” real-CLI verification recipes
...
Contributing: [CONTRIBUTING.md](CONTRIBUTING.md) Â· Authoring: [docs/authoring.md](docs/authoring.md)
