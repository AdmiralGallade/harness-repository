> **Attribution:** This harness is sourced from [harness/harness-skills](https://github.com/harness/harness-skills) by [@harness](https://github.com/harness), used under the Apache License 2.0. No modifications have been made to the original files.
