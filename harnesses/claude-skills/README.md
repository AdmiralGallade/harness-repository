# Claude Code Skills & Plugins â€” Agent Skills for Every Coding Tool

> **Attribution:** This harness is sourced from [alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills) by [@alirezarezvani](https://github.com/alirezarezvani), used under the MIT License. No modifications have been made to the original files.

**338 production-ready Claude Code skills, plugins, and agent skills for 13 AI coding tools.**

The most comprehensive open-source library of Claude Code skills and agent plugins â€” also works with OpenAI Codex, Gemini CLI, Cursor, and 9 more coding agents. Reusable expertise packages covering engineering, DevOps, marketing (incl. AEO â€” Answer Engine Optimization for LLM citation), security (PreToolUse hooks), compliance, C-level advisory (incl. founder-mode CFO/CMO/CRO/CPO/COO/CHRO/CISO/GC/CDO/CAIO/CCO/VPE personas + 21 /cs:* slash commands), productivity (capture/email/reflect), an academic research stack (litreview/grants/dossier/patent/syllabus/pulse/notebooklm + hybrid router), and enterprise Research Operations (clinical-research/research-finance/market-research/product-research, v2.9.0).

**Works with:** Claude Code Â· OpenAI Codex Â· Gemini CLI Â· OpenClaw Â· Hermes Agent[^hermes] Â· Mistral Vibe[^vibe] Â· Cursor Â· Aider Â· Windsurf Â· Kilo Code Â· OpenCode Â· Augment Â· Antigravity

[^hermes]: Hermes Agent is **BYO-sync tier**: the repo ships a pre-generated `.hermes/skills/claude-skills/` tree, but you run `python scripts/sync-hermes-skills.py` once locally to install into `~/.hermes/skills/`. Uses the same agentskills.io SKILL.md standard â€” no format conversion.
[^vibe]: Mistral Vibe is also **BYO-sync tier**: the repo ships a pre-generated `.vibe/skills/claude-skills/` tree, run `./scripts/vibe-install.sh` once locally to install into `~/.vibe/skills/`. Same agentskills.io SKILL.md standard â€” no format conversion. Docs: <https://docs.mistral.ai/mistral-vibe/agents-skills>.
...
> **5,200+ GitHub stars** â€” the most comprehensive open-source Claude Code skills & agent plugins library.
...
- **SKILL.md** â€” structured instructions, workflows, and decision frameworks
- **Python tools** â€” 533 CLI scripts (all stdlib-only, zero pip installs)
- **Reference docs** â€” 676 templates, checklists, and domain-specific knowledge files
...
**Each tool gets:**
- âœ… All 338 skills converted to native format
- âœ… Per-tool README with install/verify/update steps
- âœ… Support for scripts, references, templates where applicable
- âœ… Zero manual conversion work
...
|--------|--------|------------|---------|
| **ðŸ”§ Engineering â€” Core** | 51 | Architecture, frontend, backend, fullstack, QA, DevOps, SecOps, AI/ML, data, Playwright Pro (test gen, flaky fix, migrations), self-improving agent (auto-memory curation), security suite, a11y audit | [engineering-team/](engineering-team/) |
| **âš¡ Engineering â€” POWERFUL** | 78 | Agent designer, RAG architect, database designer, CI/CD builder, security auditor, MCP builder, AgentHub, Helm charts, Terraform, self-eval, llm-wiki, tc-tracker, autoresearch-agent, **reliability portfolio** (feature-flags-architect, kubernetes-operator, chaos-engineering, slo-architect), ship-gate, security-guidance PreToolUse hook, **Matt Pocock skills** (write-a-skill, caveman, grill-me, handoff, grill-with-docs) | [engineering/](engineering/) |
| **ðŸŽ¯ Product** | 17 | Product manager, agile PO, strategist, UX researcher, UI design, landing pages, SaaS scaffolder, analytics, experiment designer, discovery, roadmap communicator, code-to-prd, apple-hig-expert | [product-team/](product-team/) |
| **ðŸ“£ Marketing** | 46 | 8 pods: Content, SEO + AEO (`aeo` â€” E-E-A-T audit, citation tracking across 5 LLMs), CRO, Channels, Growth, Intelligence, Sales + context foundation + orchestration router | [marketing-skill/](marketing-skill/) |
| **ðŸš€ Productivity** | 6 | `capture` (brain-dump-to-action), `email` pair (inbox-setup + inbox-triage), `reflect` (journal), `handoff` (Matt Pocock-inspired), `andreessen` (market-first decision mode) | [productivity/](productivity/) |
| **ðŸŽ¨ Marketing (top-level)** | 1 | `landing` â€” single-file HTML landing-page generator (4 design styles, GSAP patterns, brand palette validator) | [marketing/](marketing/) |
| **ðŸ”¬ Research (academic)** | 8 | `research` orchestrator (hybrid router + fallback) + 7 specialists: `pulse`, `litreview`, `grants` (NIH), `dossier`, `patent`, `syllabus`, `notebooklm` | [research/](research/) |
| **ðŸ§ª Research Operations** âœ¨v2.9.0 | 5 | Enterprise/cross-functional research: orchestrator + `clinical-research` (study design), `research-finance` (R&D program finance), `market-research` (sizing/survey/segmentation), `product-research` (user research) â€” each with onboarding + customization + opt-in autoresearch bridge | [research-ops/](research-ops/) |
| **ðŸ“‹ Project Management** | 9 | Senior PM, scrum master, Jira, Confluence, Atlassian admin, templates + bundled Atlassian Remote MCP | [project-management/](project-management/) |
| **ðŸ¥ Regulatory & QM** | 18 | ISO 13485, MDR 2017/745, FDA, ISO 27001, GDPR, SOC 2, CAPA, risk management | [ra-qm-team/](ra-qm-team/) |
| **ðŸ›¡ï¸ Compliance OS** | 9 | Compliance operating system â€” controls, evidence, audit-readiness workflows | [compliance-os/](compliance-os/) |
| **ðŸ’¼ C-Level Advisory** | 66 | Full C-suite (CEO/CTO/CFO/CMO/CRO/CPO/COO/CHRO/CISO/GC/CDO/CAIO/CCO/VPE) + founder-mode agents + orchestration + board meetings + culture & collaboration | [c-level-advisor/](c-level-advisor/) |
| **ðŸ“ˆ Business & Growth** | 5 | Customer success, sales engineer, revenue ops, contracts & proposals, BizDev toolkit | [business-growth/](business-growth/) |
| **ðŸ­ Business Operations** | 7 | Orchestrator + process-mapper, vendor-management, capacity-planner, internal-comms, knowledge-ops, procurement-optimizer | [business-operations/](business-operations/) |
| **ðŸ¤ Commercial** | 8 | Orchestrator + pricing-strategist, deal-desk, partnerships-architect, channel-economics, commercial-policy, rfp-responder, commercial-forecaster | [commercial/](commercial/) |
| **ðŸ’° Finance** | 4 | Financial analyst (DCF, budgeting, forecasting), SaaS metrics coach, business investment advisor | [finance/](finance/) |

---

## Personas

Pre-configured agent identities with curated skill loadouts, workflows, and distinct communication styles. Personas go beyond "use these skills" â€” they define how an agent thinks, prioritizes, and communicates.
...
```
Week 1-2: startup-cto + aws-solution-architect + senior-frontend â†’ Build
Week 3-4: growth-marketer + launch-strategy + copywriting + seo-audit â†’ Prepare
Week 5-6: solo-founder + email-sequence + analytics-tracking â†’ Ship and iterate
```
...
| **database-schema-designer** | Requirements â†’ migrations, types, seed data, RLS policies |
| **migration-architect** | Migration planner, compatibility checker, rollback generator |
| **skill-security-auditor** | ðŸ”’ Security gate â€” scan skills for malicious code before installation |
| **ci-cd-pipeline-builder** | Analyze stack â†’ generate GitHub Actions / GitLab CI configs |
...
| **api-test-suite-builder** | Scan API routes â†’ generate complete test suites |
...
| **changelog-generator** | Conventional commits â†’ structured changelogs |
| **codebase-onboarding** | Auto-generate onboarding docs from codebase analysis |
| **runbook-generator** | Codebase â†’ operational runbooks with commands |
...
## ðŸ”’ Skill Security Auditor

New in v2.0.0 â€” audit any skill for security risks before installation:
...
- `engineering/git-worktree-manager` â€” worktree lifecycle + cleanup automation scripts
- `engineering/mcp-server-builder` â€” OpenAPI -> MCP scaffold + manifest validator
- `engineering/changelog-generator` â€” release note generator + conventional commit linter
- `engineering/ci-cd-pipeline-builder` â€” stack detector + pipeline generator
- `marketing-skill/prompt-engineer-toolkit` â€” prompt A/B tester + prompt version/diff manager
...
| [**Product Manager Skills**](https://github.com/Digidai/product-manager-skills) | Senior PM agent with 6 knowledge domains, 12 templates, 30+ frameworks â€” discovery, strategy, delivery, SaaS metrics, career coaching, AI product craft |
| [**toprank**](https://github.com/nowork-studio/toprank) | 9 SEO and Google Ads skills for Claude Code â€” connects Google Search Console, PageSpeed Insights, and Google Ads API; ships meta tag, schema markup, and keyword bid fixes to source or CMS. MIT, 107 stars |
...
Yes. Skills work natively with 13 tools: Claude Code, OpenAI Codex, Gemini CLI, OpenClaw, Hermes Agent, Mistral Vibe, Cursor, Aider, Windsurf, Kilo Code, OpenCode, Augment, and Antigravity. Hermes Agent and Mistral Vibe both use the same agentskills.io SKILL.md standard â€” run `python scripts/sync-hermes-skills.py` or `./scripts/vibe-install.sh` to install. For other tools run `./scripts/convert.sh --tool all` then `./scripts/install.sh --tool <name>`. See [Multi-Tool Integrations](https://alirezarezvani.github.io/claude-skills/integrations/) for details.
...
Yes. All 533 Python CLI tools use the standard library only â€” zero pip installs required. Every script is verified to run with `--help`.
...
**Built by [Alireza Rezvani](https://alirezarezvani.com)** Â· [Medium](https://alirezarezvani.medium.com) Â· [Twitter](https://twitter.com/nginitycloud)
